<template>
    <div class="max-w-screen-sm mx-auto px-4 py-10">
        ...
        <form 
            ...
            <div class="flex flex-col mb-2">
                <label for="confirmPassword" class="mb-1 text-sm text-light-green-300">Confirm Passowrd</label>
                <input 
                    type="password" name="confirmPassword" id="confirmPassword" v-model="fields.confirmPassword"
                    class="p-2 text-gray-500 focus:outline-none border border-light-gray-500 rounded-md hover:border-light-green-300 duration-300" required>
            </div>
            ...
            <router-link class="text-sm mt-6 text-center" :to="{name: 'Signin'}">
                Already have an account? <span class="font-semibold text-light-green-300 hover:underline">Signin</span> 
            </router-link>
        </form>
    </div>
</template>
